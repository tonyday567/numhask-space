...
import Prelude
type Spaceable a = (Eq a, Lattice a, BoundedJoinSemiLattice a, BoundedMeetSemiLattice a)
...
instance (Space a, BoundedJoinSemiLattice a) => Monoid (Union a) where
  mempty = Union bottom
...
instance (Space a, BoundedMeetSemiLattice a) => Monoid (Intersection a) where
